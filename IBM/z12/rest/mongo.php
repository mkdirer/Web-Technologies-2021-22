...
class db {
    ...
    function __construct() {
      ...
      $this->conn = new MongoDB\Client("mongodb+srv://9wajda:pass9wajda@cluster0.tmqtc.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");      
    ...
    function find_record($ident) {
      $cursor = $this->collection->find($ident);
      $table = iterator_to_array($cursor);
      return $table ;
    }
