...
function _list() {
   ...
   request.open("GET", "http://pascal.fis.agh.edu.pl/~9wajda/TI/z12/rest/list", true);
   request.send(null);
}
...
function _insert(form)  {
    ...
    request.open("POST", "http://pascal.fis.agh.edu.pl/~9wajda/TI/z12/rest/save", true);
    request.send(txt);
}
...
function _delete(form) {
    ...
    request.open("DELETE", "http://pascal.fis.agh.edu.pl/~9wajda/TI/z12/rest/delete1/"+id_mongo, true);
...
function _update(form) {
    ...
    request.open("PUT", "http://pascal.fis.agh.edu.pl/~9wajda/TI/z12/rest/update1/"+id_mongo, true);
    request.send(txt);
}
...
function _find(form){
   ...
   document.getElementById('data').innerHTML = '';  
	...
	request.open("POST", "http://pascal.fis.agh.edu.pl/~9wajda/TI/z12/rest/find", true);
