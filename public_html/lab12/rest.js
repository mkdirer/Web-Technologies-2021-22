...
function _list() {
   ...
   request.open("GET", "http://pascal.fis.agh.edu.pl/~grazyna/lab__12/rest/list", true);
   request.send(null);
}
...
function _insert(form)  {
    ...
    request.open("POST", "http://pascal.fis.agh.edu.pl/~9wajda/lab12/rest/save", true);
    request.send(txt);
}
...
function _del_list() {
    ...
    request.open("GET", "http://pascal.fis.agh.edu.pl/~9wajda/lab12/rest/list", true);
    request.send(null);
}
...
print (id_mongo);
    request.open("DELETE", "http://pascal.fis.agh.edu.pl/~9wajda/lab12/rest/delete1/"+id_mongo, true);
...
function _update(form) {
    ...
    request.open("PUT", "http://pascal.fis.agh.edu.pl/~9wajda/lab12/rest/update1/"+id_mongo, true);
    request.send(txt);
}
